...
def main():  
    ...
    st.markdown("<h1 style='text-align: center;'> CROP RECOMMENDER", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: center;'> Fill in the details of your soil profile, and let us deliver tailored recommendations for optimal crop growth", unsafe_allow_html=True)
    st.sidebar.title("Smart-Agro")
    ...
    if st.sidebar.button("Recommend Crop(s)"):
